...
# Initialize the total fee variable
total_fee = 0.0
...
L1
...
# Get the seating capacities and the allocated lab from the user
...
allocated_lab = input("Enter the lab allocated for ACE training (L1, L2, L3): ")
...
2 
...
# Get the seating capacities and number of students from the user
capacity_L1 = int(input("Enter the seating capacity of L1: "))
capacity_L2 = int(input("Enter the seating capacity of L2: "))
capacity_L3 = int(input("Enter the seating capacity of L3: "))
...
# Initialize variables to track the suitable lab and its capacity
suitable_lab = None
max_capacity = -1

# Check each lab's capacity to find the most suitable one
...
# Print the suitable lab or indicate no suitable lab was found
if suitable_lab:
    print(suitable_lab)
else:
